...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/1.JPG}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/12.JPG}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/4.JPG}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/13.JPG}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/5.JPG}
...
理論値だとLEDを30個並列に並べれば単純計算で1.2\si{\milli\ampere}発生するはずです。
他の実験と同じ日に行いたかったのですが、太陽沈んでしまったので別の日に実験しました。

\begin{figure}[htbp]
    \centering
    \includegraphics[width=60mm]{./assets/mouse/10.JPG}
